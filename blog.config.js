...
const BLOG = {
    ...
    NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || "dc9aea5a7990498384a208b79b5f0757",
    ...
    KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || "博客,数学,计算机,生活", // 网站关键词 英文逗号隔开

    // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
    CONTACT_EMAIL:
        process.env.NEXT_PUBLIC_CONTACT_EMAIL || "yoghurtlee123@gmail.com", // 邮箱地址 例如mail@tangly1024.com
    CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || "", // 你的微博个人主页
    CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || "", // 你的twitter个人主页
    CONTACT_GITHUB:
        process.env.NEXT_PUBLIC_CONTACT_GITHUB ||
        "https://github.com/yoghurtlee-thu", // 你的github个人主页 例如 https://github.com/tangly1024
    CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || "", // 你的telegram 地址 例如 https://t.me/tangly_1024
    CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || "", // 你的linkedIn 首页
    CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || "", // 您的instagram地址
    CONTACT_BILIBILI:
        process.env.NEXT_PUBLIC_CONTACT_BILIBILI ||
        "https://space.bilibili.com/1354054183", // B站主页
    ...
    BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || "京ICP备2024074926号-2", // 备案号 闽ICP备XXXXXXX
    ...
    COMMENT_GISCUS_REPO_ID:
        process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || "", // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
    ...
    COMMENT_VALINE_SERVER_URLS:
        process.env.NEXT_PUBLIC_VALINE_SERVER_URLS || "", // 该配置适用于国内自定义域名用户, 海外版本会自动检测(无需手动填写) @see https://valine.js.org/configuration.html#serverURLs
    ...
    AD_WWADS_BLOCK_DETECT:
        process.env.NEXT_PUBLIC_WWADS_AD_BLOCK_DETECT || false, // 是否开启WWADS广告屏蔽插件检测,开启后会在广告位上以文字提示 @see https://github.com/bytegravity/whitelist-wwads
