...
const BLOG = {
    ...
    NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'dc9aea5a7990498384a208b79b5f0757',
  ...
  IS_TAG_COLOR_DISTINGUISHED:
    ...
    CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'yoghurtlee123@gmail.com', // 邮箱地址 例如mail@tangly1024.com
    CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
    CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
    CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/yoghurtlee-thu', // 你的github个人主页 例如 https://github.com/tangly1024
